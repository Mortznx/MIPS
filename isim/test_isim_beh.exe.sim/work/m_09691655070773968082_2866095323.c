...
#endif
static const char *ng0 = "/home/morteza/ControllerVerilog/ForwardingUnit.v";
...
LAB52:    t321 = (t0 + 3984);
    ...
    *((unsigned int *)t331) = (t333 | t327);
    xsi_driver_vfirst_trans(t321, 0, 1);
    t334 = (t0 + 3888);
    *((int *)t334) = 1;
...
LAB58:    memcpy(t202, t165, 8);

LAB59:    memset(t234, 0, 8);
    t235 = (t202 + 4);
...
LAB76:    memcpy(t272, t234, 8);

LAB77:    memset(t162, 0, 8);
    t304 = (t272 + 4);
...
LAB90:    if (*((unsigned int *)t304) != 0)
        goto LAB91;

LAB92:    t311 = (t162 + 4);
    t312 = *((unsigned int *)t162);
    t313 = *((unsigned int *)t311);
    t314 = (t312 || t313);
    if (t314 > 0)
        goto LAB93;

LAB94:    t316 = *((unsigned int *)t162);
    t317 = (~(t316));
...
LAB96:    if (*((unsigned int *)t311) > 0)
        goto LAB97;

LAB98:    if (*((unsigned int *)t162) > 0)
        goto LAB99;

LAB100:    memcpy(t161, t320, 8);
...
LAB79:    *((unsigned int *)t249) = 1;

LAB81:    memset(t264, 0, 8);
    t265 = (t249 + 4);
...
LAB97:    xsi_vlog_unsigned_bit_combine(t161, 2, t315, 2, t320, 2);
    goto LAB101;

LAB99:    memcpy(t161, t315, 8);
    goto LAB101;
...
extern void work_m_09691655070773968082_2866095323_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_33_1};
	xsi_register_didat("work_m_09691655070773968082_2866095323", "isim/test_isim_beh.exe.sim/work/m_09691655070773968082_2866095323.didat");
